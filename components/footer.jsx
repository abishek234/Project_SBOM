...
export default function Footer() {
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col md:flex-row items-center w-full justify-between gap-4 py-6 pb-8">
                <p>Unified Project Risk Management & SBOM Intelligence</p>
                <p className="text-sm text-gray-300">Copyright © 2026 <a href="#" target="_blank">Verix</a> • All rights reserved.</p>
            </div>
        </motion.footer>
    );
};